...
fn solve_cozy_exp(fen: &str, depth: u32, threads: usize, max_nodes: Option<u64>) -> piebot::search::alphabeta_temp::SearchResult {
    ...
    } else { use_tt = true; order_caps = true; use_hist = true; use_kill = true; use_null = true; use_asp = true; use_lmr = true; }
...
fn main() {
    ...
    for (i, case) in cases.iter().enumerate() {
        ...
        let mut r = solve_cozy_exp(&case.fen, start_depth, threads, max_nodes);
        ...
        while cur_depth <= max_depth {
            r = solve_cozy_exp(&case.fen, cur_depth, threads, max_nodes);
